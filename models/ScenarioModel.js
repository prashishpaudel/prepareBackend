...
module.exports = {
	...
	getPreassessmentResponse1: function (inputparams, callback) {
		try {
			query = "select * from prepare.preassessment_response where course_id=?;"
	...
	getPostassessmentResponse1: function (inputparams, callback) {
		try {
			query = "select * from prepare.postassessment_response where course_id=?;"
	...
	getStreamDataResultsHR: function (inputparams, callback) {
		try {
			query = "SELECT round(creationTimestamp/1000) as tp, feature as label, avg(value)  as val FROM prepare.physlogicaltable where SERIALNUMBER=?  and creationTimestamp> ? and creationTimestamp < ? and feature ='HEART_RATE' group by  tp, label order by tp asc;"
	...
	getGoalsObjectives: function (inputparams, callback) {
		try {
			...
			query = "SELECT * FROM prepare.scenario_goals where course_id=?;"
	...
	getPreassessmentResponse: function (inputparams, callback) {
		try {
			...
			query = "select * from prepare.preassessment_response where course_id=? and LEARNER_ID in (?);"
	...
	getPostassessmentResponse: function (inputparams, callback) {
		try {
			...
			query = "select * from prepare.postassessment_response where course_id=? and LEARNER_ID in (?);"
	...
	getPreassessmentDetails: function (inputparams, callback) {
		try {
			...
			query = "select * from prepare.scenario_preassessment where course_id=?;"
			return pool.query(query, [inputparams.courseId], function (err, results) {
	...
	getPostassessmentDetails: function (inputparams, callback) {
		try {
			...
			query = "select * from prepare.scenario_postassessment where course_id=?;"
			return pool.query(query, [inputparams.courseId], function (err, results) {
	...
	getCourseDetails: function (inputparams, callback) {
		try {
			query = "SELECT * FROM prepare.course where course_id=?"
	...
	getActiveDevices: function (inputparams, callback) {
		try {
			query = "SELECT SERIALNUMBER FROM (SELECT SERIALNUMBER, creationTimestamp FROM prepare.physlogicaltable order by id desc limit 250000) as t where creationTimestamp>=? group by SERIALNUMBER;"
	...
	getStreamDataResultsRawCSV: function (inputparams, callback) {
		try {
			query = "SELECT  * FROM prepare.physlogicaltable where SERIALNUMBER in ((SELECT SERIALNUMBER FROM prepare.connected_devices where PLAY_ID=?))  and creationTimestamp> ? and creationTimestamp < ? order by id asc;"
	...
	getStreamDataResultsRaw: function (inputparams, callback) {
		try {
			query = "SELECT  * FROM prepare.physlogicaltable where SERIALNUMBER=?  and creationTimestamp> ? and creationTimestamp < ? order by id asc;"
	...
	getStreamDataResults: function (inputparams, callback) {
		try {
			...
			query = "SELECT round(creationTimestamp/1000) as tp, feature as label, avg(value)  as val FROM prepare.physlogicaltable where SERIALNUMBER=?  and creationTimestamp> ? and creationTimestamp < ? group by  tp, label order by tp asc;"
	...
	getStreamDataResultsCSV: function (inputparams, callback) {
		try {
			query = "SELECT round(creationTimestamp/1000) as tp, feature as label, avg(value)  as val FROM prepare.physlogicaltable where SERIALNUMBER in ((SELECT SERIALNUMBER FROM prepare.connected_devices where PLAY_ID=?))  and creationTimestamp> ? and creationTimestamp < ? group by  tp, label order by tp asc;"
	...
	getStreamData1: function (inputparams, callback) {
		try {
			...
			query = "SELECT value, source, type, creationTimestamp,feature from prepare.physlogicaltable where (creationTimestamp >  ?) order by creationTimestamp asc"
	...
	getStreamData: function (inputparams, callback) {
		try {
			...
			query = "SELECT feature, avg(value) as value FROM prepare.physlogicaltable  where creationTimestamp > ?  and SERIALNUMBER = ?  group by feature"
	...
	getGoalsObjectivesbyscenarioid: function (s_id, callback) {
		try {
			...
			query = "select * from prepare.scenario_goals sg  where COURSE_ID in (select COURSE_ID from scenario where SCENARIO_ID=?);"
			return pool.query(query, s_id, function (err, results) {
	...
	traineeHistorySkills: function (lname, callback) {
		...
		try {
			...
			query = "SELECT  skill_type,pe.play_id, avg(pe.points) as points FROM prepare.played_events pe LEFT JOIN prepare.events e ON e.EVENT_ID = pe.EVENT_ID LEFT JOIN prepare.plays_trainee pt ON pt.play_id = pe.play_id and pt.scenario_role_id=pe.scenario_role_id where pt.trainee_l_name=? group by skill_type,pe.play_id;"
	...
	traineeHistorySpecificSkill: function (lname, callback) {
		...
		try {
			...
			query = "SELECT  specific_skill,pe.play_id, avg(pe.points) as points FROM prepare.played_events pe LEFT JOIN prepare.events e ON e.EVENT_ID = pe.EVENT_ID LEFT JOIN prepare.plays_trainee pt ON pt.play_id = pe.play_id and pt.scenario_role_id=pe.scenario_role_id where pt.trainee_l_name=? group by specific_skill,pe.play_id;"
	...
	traineeHistoryEvent: function (lname, callback) {
		...
		try {
			...
			query = "SELECT  event_name,pe.play_id, avg(pe.points) as points FROM prepare.played_events pe LEFT JOIN prepare.events e ON e.EVENT_ID = pe.EVENT_ID LEFT JOIN prepare.plays_trainee pt ON pt.play_id = pe.play_id and pt.scenario_role_id=pe.scenario_role_id where pt.trainee_l_name=? group by event_name,pe.play_id;"
	...
	getCourses: function (callback) {
		try {
			...
			query = "SELECT s.*, u.username  FROM prepare.course s left join users u on u.id=s.id where s.course_id > 35 and s.INACTIVE=0";
	...
	getScenario: function (callback) {
		try {
			query = "SELECT CATEGORY as DISCIPLINE, SCENARIO_NAME as `SCENARIO NAME`, (TIME_DURATION/60) as 'TIME DURATION', scenario_id  FROM prepare.scenario  where scenario_id>31"
	...
	addAudioStream: function (inputdata, callback) {
		try {
			query = "INSERT INTO audio_stream (Room, Ip, Port) VALUES (?, ?, ?)";

			return pool.query(query, [inputdata.Room, inputdata.Ip, inputdata.Port], function (err, results) {
				if (!err) {
					var ress = {
